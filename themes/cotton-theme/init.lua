...
local theme_dir = gears.filesystem.get_configuration_dir() .. 'themes/cotton-theme/'
...
local theme_overrides = function(theme)
	theme.wallpaper = {
		...
		default = theme_dir .. "Default.png", -- this is a fallback, do not edit!
		afternoon = theme_dir .. "Background.png", -- 'afternoon' is considered the time default, uncomment only these lines in case of a non-time-based setup
		morning = theme_dir .. "Background.png",
		evening = theme_dir .. "Background.png",
		night = theme_dir .. "Background.png",
...
--		night_thunder
	...
	theme.gif_ratio = 8/6
	theme.welcomegif_width = dpi(385*theme.gif_ratio)
	theme.welcomegif_height = dpi(493*theme.gif_ratio)
